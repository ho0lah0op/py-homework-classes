...
# Вычисление средних оценки за курс
average_grade_for_python = calculate_average_grade_for_course([student1, student2], "Python")
average_grade_for_git = calculate_average_grade_for_course([student1, student2], "Git")
average_grade_for_lectures_python = calculate_average_grade_for_lectures([lecturer1, lecturer2], "Python")
average_grade_for_lectures_git = calculate_average_grade_for_lectures([lecturer1, lecturer2], "Git")

# Вывод данных
print("\033[1mОбщая информация:\033[0m", end="\n")
print(f"Средняя оценка за курс Python: {average_grade_for_python}")
print(f"Средняя оценка лекторов за курс Python: {average_grade_for_lectures_python}")
print(f"Средняя оценка за курс Git: {average_grade_for_git}")
print(f"Средняя оценка лекторов за курс Git: {average_grade_for_lectures_git}")
print("\n\033[1mДетальная информация по студентам, лекторам и ревьюерам:\033[0m", end="\n")

if student1 > student2:
    print(f"-> {student1.surname} является лучшим студентом в школе")
elif student1 < student2:
    print(f"-> {student2.surname} является лучшим студентом в школе")
else:
    print(f"-> {student1.surname} и {student2.surname} являются лучшими студентами в школе")

if lecturer1 > lecturer2:
    print(f"-> {lecturer1.surname} является лучшим лектором в школе")
elif lecturer1 < lecturer2:
    print(f"-> {lecturer2.surname} является лучшим лектором в школе")
else:
    print(f"-> {lecturer1.surname} и {lecturer2.surname} являются лучшими студентами в школе")

print(f"\n\033[1mСписок всех студентов\033[0m\n{student1}\n\n{student2}\n")
print(f"\033[1mСписок всех лекторов\033[0m\n{lecturer1}\n\n{lecturer2}\n")
print(f"\033[1mСписок всех ревьюеров\033[0m\n{reviewer1}\n\n{reviewer2}\n")
